...
func NewGRPCServer(endpoints dbendpoint.Set, logger log.Logger) pb.DbsvcServer {
...
func NewGRPCClient(conn *grpc.ClientConn, logger log.Logger) dbservice.Service {
