...
func (svc GrpcService) PushGrid(ctx context.Context, cityId string, grids map[int64][]byte) error {
	resp, err := svc.pushGrid(ctx, proto.PushGridRequest{CityId: cityId, Grids: grids})
	if err != nil {
		return err
	}
