...
type Event struct {
	...
	TagsCount            []int32  `protobuf:"varint,4,rep,packed,name=TagsCount,proto3" json:"TagsCount,omitempty"`
	Title                string   `protobuf:"bytes,5,opt,name=Title,proto3" json:"Title,omitempty"`
	Start                int64    `protobuf:"varint,6,opt,name=Start,proto3" json:"Start,omitempty"`
	Finish               int64    `protobuf:"varint,7,opt,name=Finish,proto3" json:"Finish,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Event) GetTagsCount() []int32 {
	if m != nil {
		return m.TagsCount
	}
	return nil
...
var fileDescriptor_ac8e6d38f431921d = []byte{
	...
	,
}
		...
		case 4:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.TagsCount) == 0 {
					m.TagsCount = make([]int32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int32
					for shift := uint(0); ; shift += 7 {
