...
type Event struct {
	...
	Locations            []Point  `protobuf:"bytes,9,rep,name=Locations,proto3" json:"Locations"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Event) GetLocations() []Point {
	if m != nil {
		return m.Locations
	}
	return nil
...
var fileDescriptor_ac8e6d38f431921d = []byte{
	...
	,
}
...
func (m *Event) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			m.Locations = append(m.Locations, Point{})
